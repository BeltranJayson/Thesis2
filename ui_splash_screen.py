...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p>Transcripter <span style=\" font-style:italic;\">Bot</span></p></body></html>", None))
